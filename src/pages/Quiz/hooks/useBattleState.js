...
export function useBattleState(selectedMonster) {
  ...
  const [battleActions, setBattleActions] = useState({
    ...
    enemyActionRevealed: false,
    playerAnswered: false,
    playerAttackComplete: false,
  ...
  // Estados para efecto de brillo al recibir daño
  ...
  // Procesar ataque del jugador (primera fase)
  const processPlayerAttack = (playerAction, gameLogic) => {
    console.log(`[ATAQUE DEL JUGADOR]`)
    console.log(`- Acción: ${playerAction}`)
    console.log(``)
    ...
    console.log(``)
    console.log(`[APLICAR EFECTOS DEL JUGADOR]`)
    ...
    if (enemyDamage > 0) {
      ...
      // Activar efecto de brillo al recibir daño
  ...
  // Procesar ataque del enemigo (segunda fase)
  const processEnemyAttack = (enemyAction, playerAction, gameLogic) => {
    console.log(`[ATAQUE DEL ENEMIGO]`)
    console.log(`- Acción: ${enemyAction}`)
    console.log(``)
    ...
    console.log(``)
    console.log(`[APLICAR EFECTOS DEL ENEMIGO]`)
  ...
  // Procesar batalla (compara acciones y aplica efectos simultáneamente) - MANTENER PARA COMPATIBILIDAD
